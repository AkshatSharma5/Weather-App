    ...
    return(
        <>  
            <div className="h-[12vh] w-[100vw] font-poppins flex items-center bg-gradient-to-r from-prim via-blue-500 to-sky-300 brightness-105">
                ...
                <h1 className="2xl:text-3xl font-mainn text-white text-2xl font-bold ml-[1.5vw] mr-[1.5vw]">Weather App</h1>
                <img src={live} alt="live-fav" className="h-[8vh] animate-pulse mr-[4vh] xxs:hidden xs:inline-block"/>
                <div className="bg-gradient-to-r from-green-100 via-blue-300 to-purple-300 opacity-75  drop-shadow-md text-black font-bold p-2 rounded-xl shadow-md font-mainn xxs:hidden md:inline-block">Live Weather Broadcast in your pocket!</div>
                <div className="font-mainn bg-sky-600 rounded-lg  px-3 py-1 mr-[2vw] drop-shadow-2xl shadow-black center text-white text-md xl:ml-[25vw] lg:ml-[25vw] xxs:hidden xl:inline-block hover:shadow-md hover:bg-sky-700 transition-all ">Created by Akshat Sharma with React and ❤️</div>
            </div>
        </>
    )
}
